pipeline {
  ...
  stages {
    ...
    stage ('DEV Deploy') {
          ...
          deploy adapters: [tomcat9(credentialsId: '579fbd2e-fd7b-467b-9290-613b00c83c5a', path: '', url: 'http://ec2-3-9-29-100.eu-west-2.compute.amazonaws.com:8080')], contextPath: null, war: '**/*.war'
          }
        }
